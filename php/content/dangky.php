...
<div id="a" class="modal"> 
  <form class="modal-content animate" action="#" method="POST" autocomplete="off" id="formDangky" enctype="multipart/form-data"> 
    ...
    <div class="container">
      ...
      <h5>Tài khoản: <input type="input" id="username" class="dangky" placeholder="Nhập tên tài khoản" name="username"></h5>
      <h5>Nhập mật khẩu: <input type="password" id="pass" class="form-control" placeholder="Nhập mật khẩu" name="pass">  </h5>
      <h5>Nhập lại mật khẩu: <input type="password" id="repass" class="form-control" placeholder="Nhập lại mật khẩu" name="repass"></h5>
      <h5>Email: <input type="input" id="email" class="dangky" placeholder="Nhập email abc@gmail.com" name="email"> </h5>
      <h5>Số điện thoại: <input type="text" id="sdt" class="dangky" placeholder="Nhập số điện thoại" name="sdt"></h5> 
      <h5>Xác nhận <input type="text" id="captcha" name="captcha" maxlength="6" size="6"><img src="http://127.0.0.1/webMap/php/content/captcha_code.php" title="" alt="" /></h5>
